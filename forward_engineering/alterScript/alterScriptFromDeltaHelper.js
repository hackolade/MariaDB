...
const getAlterContainersScriptDtos = (collection, app, { skipModified } = {}) => {
	const { getAddContainerScriptDto, getDeleteContainerScriptDto, getModifyContainerScriptDtos } =
...
const getAlterViewScriptDtos = (collection, app) => {
	...
	return [...deleteViewsScriptDtos, ...createViewsScriptDtos, ...modifiedViewsScriptDtos].filter(Boolean);
};
...
const getAlterScriptDtos = (data, app) => {
	...
	return [...containersScriptDtos, ...collectionsScripts, ...viewScriptDtos, ...relationshipScriptDtos]
		.filter(Boolean)
