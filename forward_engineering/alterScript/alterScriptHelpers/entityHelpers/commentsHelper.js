...
const getUpdatedCommentOnCollectionScriptDto = (_, ddlProvider) => collection => {
	const { getTableName, escapeQuotes, getCollectionSchema, getCollectionName, getDatabaseName, wrapInSingleQuotes } =
...
const getDeletedCommentOnCollectionScriptDto = (_, ddlProvider) => collection => {
	const { getTableName, getCollectionSchema, getCollectionName, getDatabaseName } = require('../../../utils/general')(
		{ _ },
	);
