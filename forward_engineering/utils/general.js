...
module.exports = ({ _, wrap }) => {
	...
	const getTableOptions = (options = {}) => {
		...
		const optionKeywords = TableOptionsByEngine[engine] || [
			'KEY_BLOCK_SIZE',
			'PACK_KEYS',
	...
	const getContainerName = containerData => containerData.code || containerData.name || containerData.collectionName;
